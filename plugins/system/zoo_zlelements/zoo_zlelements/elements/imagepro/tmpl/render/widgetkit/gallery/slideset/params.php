	...
	'{"fields": {
		...
		"main_layout_wrapper":{
			...
			"fields": {
				...
				"widget_settings": {
					"type":"subfield",
					"path":"elements:pro\/tmpl\/render\/widgetkit\/gallery\/slideset\/settings.php"
				},
				"image_separator":{
					"type": "separator",
				...
				"image_options": {
					...
					"adjust_ctrl":{
						"pattern":'.json_encode('/\[widgetkit\]\[settings\]/').',
						"replacement":""
					}
				},
				"_link_to_item":{
		...
		"main_spotlight_wrapper":{
			...
			"fields": {
				...
				"spotlight":{
					...
					"dependents":"spotlight_wrapper > 1",
					"layout":"separator"
				},
				"spotlight_wrapper":{
					"type": "wrapper",
