	...
	public function onAfterRoute()
	{
		...
		switch (true)
		{
			...
			case ($this->isadmin) :
				...
				RLFunctions::script('betterpreview/script.min.js', '5.0.1.p');
				RLFunctions::stylesheet('regularlabs/style.min.css', '16.4.18881');
				RLFunctions::stylesheet('betterpreview/style.min.css', '5.0.1.p');

				if ($params->show_url_details)
				{
					$script = "
						var betterpreview_texts = {
							'url': '" . addslashes(html_entity_decode(JText::_('RL_URL'))) . "',
