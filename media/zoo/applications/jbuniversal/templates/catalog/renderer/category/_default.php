...
if ((int)$vars['params']->get('template.category_show', 1)) : ?>
    <div class="catalog category rborder alias-<?php echo $category->alias; ?>">
        <div class="container">

        <?php if ((int)$vars['params']->get('template.category_title_show', 1)) : ?>
            <h1 class="title catalog__title"><?php echo $title; ?></h1>
        <?php endif; ?>
<a class="contform" href="/index.php?option=com_rsform&amp;formId=1&amp;name=General%20Enquiry" target="_blank">Make an Enquiry</a>
