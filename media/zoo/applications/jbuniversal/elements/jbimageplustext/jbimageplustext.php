 ...
 */
class ElementJBImagePlusText extends ElementRepeatable implements iRepeatSubmittable
{
    /**
     * @var JBImageHelper
     */
    ...
    public function _render($params = array())
    {
        ...
        if ($template == 'link') {
            ...
            $widthPopup  = (int)$params->get('width_popup', 300);
            $widthPopup  = !$widthPopup ? 300 : $widthPopup;
            $heightPopup = (int)$params->get('height_popup', 300);
    ...
    public function _validateSubmission($value, $params)
    {
        ...
        if ($trusted_mode) {
            ...
            $result['text']    = $this->app->validator->create('string', array('required' => false))->clean($value->get('text'));
            $result['align']    = $this->app->validator->create('string', array('required' => false))->clean($value->get('align'));
        }
