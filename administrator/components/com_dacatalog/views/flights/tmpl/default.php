		...
		<div id="tablecell">
			...
			<table class="table table-striped">
				...
				<tr valign="top">
					...
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'date1', 'i.date1', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'city1From', 'i.published', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'city1To', 'i.catid', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'date2', 'i.city', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'city2From', 'i.price', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'city2To', 'i.consultation', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					<tr class="<?php echo "row$k"; ?> <?php if($_SESSION['da-id'] == $row->id) echo 'green'; ?>">
						...
						<td class="nowrap">
							<a href="index.php?option=com_dacatalog&view=<?php echo JRequest::getVar( 'view' ); ?>&layout=add&id=<?php echo $row->id; ?>"><?php echo $row->title; ?></a>
						</td>
						<td class="nowrap">
							<?php echo $row->date1; ?>
						</td>
						<td class="nowrap">
							<?php echo $row->city1From; ?>
						</td>
						<td class="nowrap">
							<?php echo $row->city1To; ?>
						</td>
						<td class="nowrap">
							<?php echo $row->date2; ?>
						</td>
						<td class="nowrap">
							<?php echo $row->city2From; ?>
						</td>
						<td class="nowrap">
							<?php echo $row->city2To; ?>
						</td>
