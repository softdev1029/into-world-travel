		...
		<div id="tablecell">
			...
			<table class="table table-striped">
				...
				<tr valign="top">
					...
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'roomTitle', 'i.roomTitle', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'city', 'i.city', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'title_hotel', 'i.title', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
					<th class="nowrap">
						<?php echo JHTML::_('grid.sort', 'stars', 'i.catid', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
					</th>
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					<tr class="<?php echo "row$k"; ?> <?php if($_SESSION['da-id'] == $row->id) echo 'green'; ?>">
						...
						<td class="nowrap">
							<a href="index.php?option=com_dacatalog&view=<?php echo JRequest::getVar( 'view' ); ?>&layout=add&id=<?php echo $row->id; ?>"><?php echo $row->roomTitle; ?></a>
							<?php if($row->alias) : ?>
