...
abstract class JHtmlFormbehavior
{
	...
	public static function chosen($selector = '.advancedSelect', $debug = null, $options = array())
	{
		...
		JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/chosen.jquery.min.js', false, true, false, false, $debug);
		JHtml::_('stylesheet', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/css/chosen.css', false, true);
