...
abstract class JHtmlSortablelist
{
	...
	public static function sortable($tableId, $formId, $sortDir = 'asc', $saveOrderingUrl, $proceedSaveOrderButton = true, $nestedList = false)
	{
		...
		JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/sortablelist.js', false, true);
		JHtml::_('stylesheet', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/css/sortablelist.css', false, true, false);
