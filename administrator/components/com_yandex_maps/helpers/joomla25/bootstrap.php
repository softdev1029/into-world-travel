...
abstract class JHtmlBootstrap
{
	...
	public static function framework($debug = null)
	{
		...
		JHtml::_('script', jURI::root().'/administrator/components/com_yandex_maps/helpers/joomla25/jui/js/bootstrap.min.js', false, true, false, false, $debug);
	...
	public static function startTabSet($selector = 'myTab', $params = array())
	{
		...
		if (!isset(static::$loaded[__METHOD__][$sig]))
		{
			...
			JFactory::getDocument()
				->addScriptDeclaration(JLayoutHelper::render('joomla.bootstrap.starttabsetscript', array('selector' => $selector)));
		...
		$html = JLayoutHelper::render('joomla.bootstrap.starttabset', array('selector' => $selector));
	...
	{
		$html = JLayoutHelper::render('joomla.bootstrap.endtabset');
	...
	public static function addTab($selector, $id, $title)
	{
		...
		$tabScriptLayout = is_null($tabScriptLayout) ? new JLayoutFile('joomla.bootstrap.addtabscript') : $tabScriptLayout;
		$tabLayout = is_null($tabLayout) ? new JLayoutFile('joomla.bootstrap.addtab') : $tabLayout;
	...
	{
		$html = JLayoutHelper::render('joomla.bootstrap.endtab');
	...
	public static function loadCss($includeMainCss = true, $direction = 'ltr', $attribs = array())
	{
		...
		if ($includeMainCss)
		{
			JHtml::_('stylesheet', jURI::root().'/administrator/components/com_yandex_maps/helpers/joomla25/jui/css/bootstrap.min.css', $attribs, true);
			JHtml::_('stylesheet', jURI::root().'/administrator/components/com_yandex_maps/helpers/joomla25/jui/css/bootstrap-responsive.min.css', $attribs, true);
			JHtml::_('stylesheet', jURI::root().'/administrator/components/com_yandex_maps/helpers/joomla25/jui/css/bootstrap-extended.css', $attribs, true);
		}

		// Load Bootstrap RTL CSS
		if ($direction === 'rtl')
		{
			JHtml::_('stylesheet', jURI::root().'/administrator/components/com_yandex_maps/helpers/joomla25/jui/css/bootstrap-rtl.css', $attribs, true);
		}
	}
}
