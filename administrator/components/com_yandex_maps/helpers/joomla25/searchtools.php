...
abstract class JHtmlSearchtools
{
	...
	public static function main()
	{
		...
		if (empty(static::$loaded[__METHOD__]))
		{
			...
			JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/jquery.searchtools.min.js', false, true);
			JHtml::_('stylesheet', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/css/jquery.searchtools.css', false, true);
