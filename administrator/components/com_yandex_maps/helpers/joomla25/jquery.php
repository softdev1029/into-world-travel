...
abstract class JHtmlJquery
{
	...
	public static function framework($noConflict = true, $debug = null, $migrate = true)
	{
		...
		JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/jquery-noconflict.js', false, true, false, false, false);
		}

		// Check if we are loading Migrate
		if ($migrate)
		{
			JHtml::_('script', jURI::root().'administrator/components/com_yandex_maps/helpers/joomla25/jui/js/jquery-migrate.min.js', false, true, false, false, $debug);
		}
