...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.52.8</h2>
		<ul class="version-history">
			<li><span class="version-fixed">Fix</span> An issue could occur in the 'Submissions - Directory' menu item where a row would show up as a duplicate.</li>
			<li><span class="version-fixed">Fix</span> An issue could occur in the 'Submissions - Directory' menu item where fields that have names consisting of only numbers would throw PHP Notices.</li>
