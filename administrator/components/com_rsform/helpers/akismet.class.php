...
class RSFPAkismetHttpClient extends RSFPAkismetObject {
...
class RSFPAkismet extends RSFPAkismetObject {
	var $apiPort = 80;
	 ...
	 *                           
	 */
	public function __construct($blogUrl, $apiKey, $comment = array()) {
		$this->blogUrl = $blogUrl;
		$this->apiKey  = $apiKey;
		$this->setComment($comment);
		
		// Connect to the Akismet server and populate errors if they exist
		$this->http = new RSFPAkismetHttpClient($this->akismetServer, $blogUrl, $apiKey);
