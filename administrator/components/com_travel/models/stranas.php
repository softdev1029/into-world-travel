...
class  travelModelstranas extends JModelList
{
    ...
    protected function getListQuery()
	{
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.country_title LIKE '.$search.' )');
			}
		}
