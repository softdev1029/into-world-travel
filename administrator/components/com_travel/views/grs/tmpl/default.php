...
$canOrder	= $user->authorise('core.edit.state', 'com_travel.gr');
$saveOrder	= 'a.ordering';
$saveOrder	= $listOrder == 'a.ordering';
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_travel&task=grs.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_travel&view=grs'); ?>" method="post" name="adminForm" id="adminForm">
...
<th width="20%" align="center" style='text-align:center'>
       ...
       <th width="20%" align="center" style='text-align:center'>
	   <?php echo JHtml::_('grid.sort', 'Группа', 'a.gr', $listDirn, $listOrder); ?>
       </th>
<th width="20%" align="center" style='text-align:center'>
...
$linkEdit	= JRoute::_('index.php?option=com_travel&task=gr.edit&id='.$item->id);

$canCheckin	= $user->authorise('core.manage',		'com_checkin') || $item->checked_out==$user->get('id') || $item->checked_out==0;
$canChange	= $user->authorise('core.edit.state',	'com_travel.gr'.$item->id);
$canCreate	= $user->authorise('core.create',		'com_travel.gr'.$item->id);
?>
...
<td class="order nowrap center hidden-phone">
    ...
    border-radius: 10px;'>Наценка: ".$p."</span>";
	  ...
	  ?></center>
        ...
        <td><center>
	<?php  
		echo '<a href="'. JRoute::_($linkEdit).'">'. $this->escape($item->gr_title).'</a>';
	  ?></center>
	</td>
    
 <td class="center"><?php echo JHtml::_('jgrid.published', $item->published, $i, 'grs.', $canChange); ?></td>
