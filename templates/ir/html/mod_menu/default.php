...
if (isset($attribs['name']) && $attribs['name'] == 'user3') {
    ...
    echo '<ul class="oba-hmenu' . $class_sfx . '"' . $tag . '>';
    foreach ($list as $i => & $item) {
        ...
        $class = 'main-menu__item item-' . $item->id;
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'oba-vmenu') || false !== strpos($params->get('moduleclass_sfx'), ' oba-vmenu')) {
    $menutype = 'vertical';
