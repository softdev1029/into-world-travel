...
if (strlen($article->created))
    $params['metadata-header-icons'][] = "<span class=\"oba-postdateicon\">" . $article->createdDateInfo($article->created) . "</span>";
if (strlen($article->modified))
    $params['metadata-header-icons'][] = "<span class=\"oba-postdateicon\">" . $article->modifiedDateInfo($article->modified) . "</span>";
if (strlen($article->published))
    $params['metadata-header-icons'][] = "<span class=\"oba-postdateicon\">" . $article->publishedDateInfo($article->published) . "</span>";
if (strlen($article->author))
    $params['metadata-header-icons'][] = "<span class=\"oba-postauthoricon\">" . $article->authorInfo($article->author, $article->authorLink) . "</span>";
...
// Render article
echo '<div class="catalog"><div class="container">'.$article->article($params).'</div></div>';
echo '<div class="catalog"><div class="container">'.$component->endPageContainer().'</div></div>';
