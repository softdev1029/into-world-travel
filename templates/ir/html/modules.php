...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'oba-nostyle';
  $styles = array(
    'oba-nostyle' => 'modChrome_artnostyle',
    'oba-block' => 'modChrome_artblock',
    'oba-article' => 'modChrome_artarticle',
    'oba-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'oba-...'        - overwrites the default module style.
  //  'suffix oba-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add oba-... to the module elements.
