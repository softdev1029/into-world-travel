<div class="zen-roomspage-gallery-wrapper">
   ...
   <a class="galery_travel" href="<?= str_replace('www.roomsxmldemo.com/RXLStagingImages', 'www.stuba.com/RXLImages', $this->all_foto[$s]['Url']) ?>">
   <img class="zen-tablet-gallery-thumb-img" src="<?=str_replace('www.roomsxmldemo.com/RXLStagingImages', 'www.stuba.com/RXLImages', $this->all_foto[$s+1]['Url']) ?>" data-photonum="3">
   </a>
   </div>
   <?php if (isset($this->all_foto[$s+1])): ?>
     <?php  $f = str_replace('www.roomsxmldemo.com/RXLStagingImages', 'www.stuba.com/RXLImages', $this->all_foto[$s+1]['Url']); ?>
    <div class="zen-tablet-gallery-thumb-wrapper">
   <a class="galery_travel" href="<?=str_replace('www.roomsxmldemo.com/RXLStagingImages', 'www.stuba.com/RXLImages', $this->all_foto[$s+1]['Url'] ) ?>">
   <img class="zen-tablet-gallery-thumb-img" src="<?=str_replace('www.roomsxmldemo.com/RXLStagingImages', 'www.stuba.com/RXLImages', $this->all_foto[$s+1]['Url'] )?>" data-photonum="3">
   </a>
   </div>
   <?php endif; ?>
