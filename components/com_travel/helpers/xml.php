...
//        </HotelSearchCriteria>
    ...
    <Org>'.$params->get('org','SampleRequest').'</Org>
    <User>'.$params->get('user','SampleRequest').'</User>
    <Password>'.$params->get('password','demo123').'</Password>
...
//Вернуть комнаты 
 static public function rooms($Availability){
