...
jQuery('.non_refundable').magnificPopup({
   items: {
      src: jQuery('<div class="white-popup">Room is fully non-refundable.</div>'),
      type: 'inline'
  }
});

jQuery('.refundable').magnificPopup({ 
   items: {
      src: jQuery('<div class="white-popup">Room does not incur a cancellation charge at the time of booking.</div>'),
      type: 'inline'
  }
});
