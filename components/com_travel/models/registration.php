 ...
 * @since		1.6
 */
class travelModelRegistration extends JModelForm
{
	/**
	...
	public function register($temp)
	{
		...
		if (($params->get('useractivation') < 2) && ($params->get('mail_to_admin') == 1)) {
			...
			foreach( $rows as $row )
			{
                ...
                JError::raiseWarning( 100, JText::_('COM_USERS_REGISTRATION_ACTIVATION_NOTIFY_SEND_MAIL_FAILED') );
		...
		if ($return !== true) {
            ...
            JError::raiseWarning( 100, JText::_('COM_USERS_REGISTRATION_SEND_MAIL_FAILED') );
