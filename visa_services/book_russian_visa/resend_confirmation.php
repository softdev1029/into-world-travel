...
{	
	...
	$msg.='<p>Dear <strong>'.$title.' '.$firstname.' '.$lastname.'</strong>,</p>
        	...
        	<p style="color: #CC6600;font-weight: bold;">Remember to submit your Russian Visa Application by completing 
        	the 
        	<a href="http://www.intouristuk.com/visa_services/book_russian_visa/application.php?vcode='.$vcode.
        	'&amp;id='.$id.'">Next Step</a>.</p>'; 
